    ...
    return (
            ...
            <div className = "col-xs-12 col-md-6 col-sm-6 col-lg-4 hello center-aligned">
                ...
                <div className="wrapper center-block">
                    <img className="play img-fluid responsive-image" src="https://i.imgur.com/z3jH6DD.png" alt = "play-button"/>
                    <img className = "img-fluid responsive-image" src={props.thumbnail} alt="search-movie-image"/>
                </div>
                </Link>
    ...
    return (
        <>
            <div className = "container">
                ...
                <div className = "row">
                    {arr.map(item => <Cards title = {item.title} id = {item.id} thumbnail = {item.thumbnail} completed = {item}/>) }
                </div>
            </div>
